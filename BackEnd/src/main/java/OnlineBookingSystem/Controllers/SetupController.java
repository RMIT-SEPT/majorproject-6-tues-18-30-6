...
public class SetupController {
    ...
    public ModelAndView login(
        ...
        if(authenticationKey.equals("1234")) {
            ...
            return mav.addObject("Error", "Incorrect Authentication key.");
        }
    }
    ...
    public ModelAndView accountSetup(
        ...
        onlinebookingsystem.setUpDefaultShifts();
    ...
    public ModelAndView edit(){
        ...
        BusinessOwner bo = onlinebookingsystem.getAllBusinessOwners().get(0);
