...
public class OpeningController {
    ...
    public ModelAndView updateOpening(
        ...
        ArrayList<WorkShift> toBeDeleted = onlineBooking.getWorkShifts(user.getId());
        ...
        onlineBooking.saveWorkShifts(toBeAdded);

        //Actually delete the old workshifts that are not selected
        onlineBooking.deleteWorkShifts(toBeDeleted);
    ...
    private ModelAndView buildOpeningHourView(int userId){
        ...
        ArrayList<Shift> shifts = onlineBooking.getShifts(userId);
        ArrayList<Day> days = onlineBooking.getDays();
        ArrayList<WorkShift> workShifts = onlineBooking.getWorkShifts(userId);
